    ...
    public function up(): void
    {
        ...
        DB::table('faqs')->insert([
            ...
            [
                ...
                'brief_answer' => 'Yes, calling ahead is encouraged.',
                'full_answer' => 'Yes. Patients are encouraged to call before visiting to confirm opening times, service availability, booking requirements, and what documents or samples may be needed for their visit.',
                'show_on_home' => false,
                'status' => 'Active',
                'display_order' => 4,
                'created_at' => $now,
            ...
            [
                ...
                'brief_answer' => 'Please confirm payment options before your visit.',
                'full_answer' => 'Payment options may vary by service and day. Patients should call the clinic before visiting to confirm whether cash, mobile money, bank transfer, card payment, or other payment methods are available at that time.',
                'show_on_home' => false,
                'status' => 'Active',
                'display_order' => 5,
                'created_at' => $now,
            ...
            [
                ...
                'brief_answer' => 'Please check with the clinic before attending.',
                'full_answer' => 'Insurance and medical scheme acceptance can depend on the scheme, service type, and current clinic arrangements. Please call ahead with your scheme details so the clinic can confirm whether it is accepted and explain any payment or claim requirements.',
                'show_on_home' => false,
                'status' => 'Active',
                'display_order' => 6,
                'created_at' => $now,
            ...
            [
                ...
                'brief_answer' => 'Call the clinic or seek urgent emergency care immediately.',
                'full_answer' => 'For urgent symptoms, call the clinic immediately for guidance. If the situation is severe or life-threatening, go to the nearest emergency facility or call local emergency support without waiting for an online appointment response. Sunday services are for emergencies and special bookings.',
                'show_on_home' => false,
                'status' => 'Active',
                'display_order' => 7,
                'created_at' => $now,
            ...
            [
                ...
                'brief_answer' => 'Bring the child health record and any medicines.',
                'full_answer' => 'For Under-5 Clinic visits, bring the child health passport or clinic card, immunization record, any current medicines, and previous test results if available. A parent or guardian should be present to provide the child\'s medical history and consent for care.',
                'show_on_home' => false,
                'status' => 'Active',
                'display_order' => 8,
                'created_at' => $now,
